...
# -----------------------------------
for chamber in LV RV LA RA ART ALL; do
  ...
  cmd=(python3 plot_vas_comparison.py
    ...
    --savepath ${RESULTS_ROOT}/VAS_plots_functional_remodelling/${chamber}
...
echo ""
echo "📁 Results saved in: ${RESULTS_ROOT}/VAS_plots_functional_remodelling/"